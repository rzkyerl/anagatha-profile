    ...
    @if ($errors->any() && !session('status'))
        <div class="toast-stack" data-toast>
            <div class="toast toast--error" role="alert" aria-live="assertive">
                ...
                <div class="toast__body">
                    <p class="toast__title">Registration Failed</p>
                    <p class="toast__message">
                        @if ($errors->has('email') && $errors->first('email') === 'This email is already registered.')
            ...
            <div class="register-form-wrapper">
                ...
                <div class="social-login social-login-top">
                    <div class="social-login-buttons">
                        <a href="{{ route('github.redirect') }}" class="social-btn social-btn--github" aria-label="Sign in with GitHub">
                            <i class="fa-brands fa-github" aria-hidden="true"></i>
                        </a>
                        <a href="{{ route('google.redirect') }}" class="social-btn social-btn--google" aria-label="Sign in with Google">
                ...
                <div class="register-footer">
                    ...
                    <p style="margin-top: 0.5rem;">
                        <a href="{{ route('register.role') }}" class="login-link" style="font-size: 0.875rem;">← Back to role selection</a>
                    </p>
                </div>
            </div>
        </div>
...
<script nonce="{{ $cspNonce ?? '' }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            ...
            @if (session('status') && session('toast_type') === 'success')
                // Registration was successful, clear the form
                form.reset();
                
                // Clear any error states
                const errorElements = form.querySelectorAll('.is-invalid, .form-error');
